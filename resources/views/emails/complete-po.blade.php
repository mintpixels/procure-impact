...
<b>Your purchase order is approved and ready to be completed. Click the link below to complete your purchase.</b>
<br><br>
<a href="{{ url('checkout/' . $order->approvedCheckout->guid) }}">{{ url('checkout/' . $order->approvedCheckout->guid) }}</a>
<br><br>
